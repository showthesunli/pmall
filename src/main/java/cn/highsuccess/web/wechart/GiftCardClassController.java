 ...
 */
@Controller
public class GiftCardClassController extends HisuBaseControllerAdapter{
    @Autowired
    @Qualifier("giftCardClass")
    private HisuMngDataGroupAndId hisuMngDataGroupAndId;

    @Autowired
    protected GiftCardClassController(JavaDataSet jds, JavaOperate javaOperate) {
        super(jds, javaOperate);
    }

    @RequestMapping(value = "/giftCardClass")
