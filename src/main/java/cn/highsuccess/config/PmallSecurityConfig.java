    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.formLogin().loginPage("/login").defaultSuccessUrl("/member")
            .and()
                ...
                .antMatchers("/myOrderList").authenticated()
                .antMatchers("/myCard").authenticated()
                .antMatchers("/myCardList").authenticated()
                .antMatchers("/myAddress").authenticated()
                .antMatchers("/myInvoice").authenticated()
                .antMatchers("/accountSafe").authenticated()
            .and()
                .rememberMe()
