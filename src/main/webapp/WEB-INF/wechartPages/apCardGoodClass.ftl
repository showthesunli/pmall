		...
		<div class="round">
			<ul>
				<#list queryAPCardPrdType as item>
                    <li><a href="<@spring.url '/goodList'/>;realDataGroupId=queryPrdList_apCardGoodClass;mrkPrdCateID=${item.mrkPrdCateID};productName=${item.productName}"><span>${item.entPrdSrlNo}</span></a></li>
				</#list>
			</ul>
		</div>
