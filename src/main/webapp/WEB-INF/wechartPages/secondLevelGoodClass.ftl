...
<div id="page">
	...
	<div id="content">
		...
		<div class="round">
			<ul>
				<li><a href="<@spring.url '/goodList'/>"><span>路由器</span></a></li>
				<li><a href="<@spring.url '/goodList'/>"><span>耳机</span></a></li>
				<li><a href="<@spring.url '/goodList'/>"><span>行车记录仪</span></a></li>
				<li><a href="<@spring.url '/goodList'/>"><span>红葡萄酒</span></a></li>
				<li><a href="<@spring.url '/goodList'/>"><span>智能监控</span></a></li>
				<li><a href="<@spring.url '/goodList'/>"><span>电子血压计</span></a></li>
			</ul>
		</div>
