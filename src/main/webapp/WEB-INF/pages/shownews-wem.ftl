...
<body>
	...
	<div class="main">
		...
		<div class="maintt">
			<div class="newTit"><h2 >途皓与沃尔玛签订合作协议书用</h2></div>
			<div class="author"><span class="time">2017-04-10</span><span class="hits"  id="hits">2</span>次</div>
		</div>
		
		<div class="mainCon">
			<div class="textCon">
				<p>途皓（北京）商务服务有限公司与沃尔玛（云南）商业零售有限公司签订合作协议书。</p>
				<p>双方将开始正式的合作，利用沃尔玛全国上百家门店为途皓（北京）及其遍布全国中高端客户服务，满足客户的日常生活服务。</p>
			</div>
