...
<div class="jf-header-top">
    <div class="jf-width1200">
        <ul class="topNav">
            ...
            <li style="background: url(<@spring.url '/images/ico2.png'/>) no-repeat  left center;"><a href="<@spring.url '/register'/>">注册</a></li>
            </@sec.authorize>
            <li style="background: url(<@spring.url '/images/ico3.png'/>) no-repeat  left center;"><a href="<@spring.url "/shoppingCart"/>">购物车</a></li>
            <li style="background: url(<@spring.url '/images/ico4.png'/>) no-repeat  left center;"><a href="<@spring.url '/help'/>" >帮助中心</a></li>
        </ul>
    </div>
</div>
<div class="top">
    ...
    <div class="nav-center">
        <ul class="nav">
            ...
            <li><a href="<@spring.url '/pro'/>">积分商城</a></li>
            <li ><a href="<@spring.url '/shangjia'/>">合作商家</a></li>
            <li><a href="<@spring.url '/onlinePurchase'/>">在线购卡</a></li>
            <li><a href="<@spring.url '/jifen'/>">积分查询</a></li>
        </ul>
    </div>
    <div class="top_right">
