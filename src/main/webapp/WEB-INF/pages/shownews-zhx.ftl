...
<body>
	...
	<div class="main">
		...
		<div class="maintt">
			<div class="newTit"><h2 >途皓与资和信电子签订合作协议</h2></div>
			<div class="author"><span class="time">2017-03-25 </span><span class="hits"  id="hits">2</span>次</div>
		</div>

		<div class="mainCon">
			<div class="textCon">
				<p>途皓（北京）商务服务有限公司与资和信电子支付有限公司云南分公司签订合作协议书</p>
				<p>双方将开始正式的合作，利用资和信的商通卡为途皓（北京）的中高端客户服务，提升客户满意度和忠诚度。</p>
			</div>
