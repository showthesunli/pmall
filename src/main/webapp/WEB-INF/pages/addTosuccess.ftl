...
<style>
.addToSucc{ text-align:center; font-size:12px; color:#666; background:#ffefe5; width:600px; margin:50px auto; padding:50px 0;}
...
<body>
    ...
    <div class="jf-main">
        <div class="ny_nav">
            <div class="ny_nav1">当前位置：<a href='<@spring.url "/index"/>'>首页</a> > <a href='<@spring.url "/shoppingCart"/>'>购物车</a> > 加入购物车成功</div>
            <div class="clearfix"></div>
        </div>
        	            
		<div class="jf-width1000 jf-overflowH" style="background:#fff; margin:10px auto;">
            <div class="addToSucc jf-overflowH">
                <p class="addToSTitle">加入购物车成功！</p>
    
                <p style="margin-top:20px;">
                    <a href="<@spring.url "/pro"/>" class="btnBgS conToShop">继续购物</a>
                    <a href='<@spring.url "/shoppingCart"/>' class="entityShopBtn">去购物车结算 ></a>
                </p>
            </div>
        </div>
