...
<body>
	...
	<div class="main">
		...
		<div class="maintt">
			<div class="newTit"><h2 >途皓与苏宁云南签订合作备忘录用</h2></div>
			<div class="author"><span class="time">2017-04-05</span><span class="hits"  id="hits">2</span>次</div>
		</div>

		<div class="mainCon">
			<div class="textCon">
				<p>途皓（北京）商务服务有限公司与云南苏宁云商销售有限公司签订合作备忘录。</p> 
				<p>双方将开始正式的合作，利用苏宁易购网上商城及苏宁线下门店，为途皓（北京）的中高端客户服务，提升客户满意度，提高粘度，激活客户。</p>
			</div>
